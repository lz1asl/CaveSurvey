...
import com.astoev.cave.survey.service.export.ExportEntityType.LEG
import com.astoev.cave.survey.service.export.ExportEntityType.MIDDLE
...
class VisualTopoExport(aContext: Context?) : AbstractExport(aContext) {
    ...
    override fun setValue(entityType: Entities, value: String) {
        val entry = when (entityType) {
            FROM -> rightPad(ensureNotEmpty(value), 12)
