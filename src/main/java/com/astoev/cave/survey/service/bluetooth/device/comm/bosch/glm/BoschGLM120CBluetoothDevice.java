...
/**
 * Bosch GLM120c over comm connection.
 * Support for distance, and inclination.
 *
 * Created by astoev on 10/11/17.
 */

public class BoschGLM120CBluetoothDevice extends AbstractBoschGLMBluetoothDevice {

    @Override
    public boolean isNameSupported(String aName) {
        return deviceNameStartsWith(aName, "BOSCH GLM120C ");
    }

    @Override
    public String getDescription() {
        return "Bosch GLM 120 C";
    }
